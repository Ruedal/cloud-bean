...
=======
    <div id="prftop" class="d-flex justify-content-center align-item-center win-vh-100">
        <form @submit.prevent="submitProfile" class="card p-2" style="margin: 10px; width: 100%">
            <h4 style="margin-top: 20px">프로필 설정</h4>
            <label for="image">
                <div class="card" ref="card">
                    <img class="card-img-top" :src="profileImage" alt="프로필 이미지를 선택해주세요" />
                    <div class="card-body"></div>
                </div>
            </label>
            <input type="file" id="image" @change="onFilechange" accept="image/*" />
