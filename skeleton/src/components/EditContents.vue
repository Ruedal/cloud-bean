            ...
            <div class="form-row d-flex">
                ...
                <div>
                    ...
                    <div class="mt-4 form-group">
                        ...
                        <br />
                        <button type="button" class="btn btn-primary m-1" @click="router.push('/tab')">취 소</button>
                        <br />
                        <button type="button" class="btn btn-primary m-1" @click="updateACHandler">수 정</button>
                    </div>
                </div>
            </div>
        </div>
