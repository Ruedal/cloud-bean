    ...
    <div id="acc" class="bg-light border border-black rounded-3">
        ...
        <div id="d3" class="d-flex flex-row">
                ...
                <div id="d5" class="flex-fill">
                    <div class="form-row d-flex">
                        <div class="form-group flex-fill">
                            ...
                            <select v-model="contents.type" @change="onTransactionTypeChange" class="form-control" id="transactionType">
            ...
            <div id="d7" class="col-sm-1">
                <button type="button" class="btn btn-outline-dark m-1" @click="resetForm">리 셋</button><br />
                <button type="button" class="btn btn-dark m-1" @click="addContentsHandler">등 록</button>
            </div>
        </div>
    </div>
</template>
