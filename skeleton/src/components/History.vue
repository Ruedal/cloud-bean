    ...
    <div id="hisli" class="col-sm-7 row m-2">
        <div id="tali" class="col p-0">
            ...
            <table class="table table-sm border border-2 table-bordered">
                            ...
                            <div id="cal">
                                <VDatePicker v-model="date">
                                    <template #default="{ togglePopover }">
                                        <button class="rounded-md" @click="togglePopover">날짜</button>
                                    </template>
                                </VDatePicker>
                            </div>
                        </th>
                        <th>
                            <select class="form-select form-select-sm text-center" name="" id="">
                ...
                <tbody class="">
                    <Contents v-for="contents in addContent" :key="contents.id" :contents="contents" />
                </tbody>
            </table>
        </div>
    </div>
